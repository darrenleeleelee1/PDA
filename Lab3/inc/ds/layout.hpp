...
public:
    ...
    int width, height;
    Block(){}
    Block(std::string n, Coordinate c, int w, int h) : name(n), ll_coor(c), width(w), height(h) {}
...
public:
    Terminal() : Block() {}
    Terminal(std::string n, Coordinate c, int w, int h) : Block(n, c, w, h) {}
...
public:
    bool is_top;
    Cell() : Block() {}
    Cell(std::string n, Coordinate c, int w, int h, bool t) : Block(n, c, w, h), is_top(t) {}
    void printBlock();
};
...
public:
    ...
    void addTerminal(std::string n, Coordinate c, int w, int h){
        Terminal* t = new Terminal(n, c, w, h);
        this->terlist.push_back(t);
    }
    void addCell(std::string n, Coordinate c, int w, int h, bool t){
